...
function get(bookId) {
    return storageService.get(BOOKS_DB_KEY, bookId)
}

function remove(bookId) {
    return storageService.remove(BOOKS_DB_KEY, bookId)
}

function save(book) {
    if (book.id) return storageService.put(BOOKS_DB_KEY, book)
    else return storageService.post(BOOKS_DB_KEY, book)
}
